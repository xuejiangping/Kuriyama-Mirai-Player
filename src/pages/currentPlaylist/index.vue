...
const rowdbClick = (row, column, cell, event) => {
	...
	console.log("🚀 => file: index.vue:24 => column:", column)
	console.log("🚀 => file: index.vue:24 => cell:", cell)
	console.log("🚀 => file: index.vue:24 => event:", event)
}
					...
					<template #default="scope">
						<div class="button-wrapper">
							...
							<svg t="1648883775602" class="icon" viewBox="0 0 1024 1024" version="1.1"
								xmlns="http://www.w3.org/2000/svg" p-id="3156" width="40" height="40" v-if="scope.row.mv">
								<path
